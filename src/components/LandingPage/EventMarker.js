...
function EventMarker(props) {
    ...
    return ( <
        ...
        <
        div className = "text-sm font-bold text-gray-600 my-4 text-left tracking-tighter" > { props.event_title } <
        /div>
        ...
        <
        div className = "text-sm text-gray-500 my-4 text-left tracking-tighter" > { props.event_category } <
        /div>
